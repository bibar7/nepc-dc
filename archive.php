...
get_header();
$holycross_container = holycross_get_container_class( 'archive-article-style' );
?>
						...
						<?php if ( have_posts() ) : ?>
							...
							<div class="slz-list-block <?php echo esc_attr( $holycross_container['block_class'] ); ?>">
								...
								<?php
									...
									if ( $holycross_template = holycross_check_article_layout('articles', 'archive-article-style') ) {
