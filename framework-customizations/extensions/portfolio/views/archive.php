...
$column     = slz_get_db_settings_option( 'portfolio-ac-column', 1 );
$limit_post = slz_get_db_settings_option('portfolio-ac-limit_post', '');
if( empty( $limit_post ) ){
			...
			<div class="row">
				<div id="page-content" class="slz-content-column <?php echo esc_attr( $slz_container_css['content_class'] ); ?>">
					<div class="service-archive-wrapper">
						<?php
						$slz_shortcode = sprintf('[slz_portfolio_list method="cat" list_category="%1$s" show_category="yes" show_meta_info="yes" pagination="yes" column="%2$s" layout="layout-1" style="style-1" description_length="30" button_text="%3$s" limit_post="%4$s"]',
