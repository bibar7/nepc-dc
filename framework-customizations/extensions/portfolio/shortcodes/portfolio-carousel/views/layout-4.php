...
$html_options = array(
    ...
    'category_format'        => '<li><a href="%2$s" class="block-category"><span class="title">'. $category_label .'</span><span class="text">%1$s</span></a></li>',
                        ...
                        <div class="block-content">
                            <div class="block-content-wrapper">
                                ...
                                <?php if(!empty($model->attributes['show_meta_info']) && $model->attributes['show_meta_info']=='yes' ): ?>
                                    <ul class="block-info">
                                        <?php echo ($model->get_term_current_taxonomy( $html_options )); ?>
