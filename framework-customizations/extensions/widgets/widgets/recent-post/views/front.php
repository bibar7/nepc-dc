...
if(!empty($instance['show_category'])){
    $category = '<div class="meta-info category">'.esc_html__('categories: ','holycross').'%7$s</div>';
}
...
$html_format =
    '<div class="media">
            ...
            <div class="media-right">%1$s
                <div class="meta">
                   '.wp_kses_post($author) .wp_kses_post($category). wp_kses_post($date).
...
$html_render['category_format'] = '<a href="%1$s" class="link">%2$s</a>';
