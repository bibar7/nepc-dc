...
<div class="slz-events-block layout-7 <?php echo esc_attr( $cls_padding ); ?>">
<?php              
...
if ($inc == 0): ?>
    <div class="main-layout item <?php echo esc_attr($model->get_post_class())?>">
        <div class="slz-block-item-07 <?php echo esc_attr( $model->attributes['has_image'] ); ?> style-02">
        <?php if( $model->has_thumbnail && $model->attributes['image_display'] == 'show' ):?>
            <div class="block-image-wrapper">
                <?php 
                    ...
                    $css = '.sc_event_block_%1$s .slz-events-block.layout-7
        ...
        <?php endif;?>
            <div class="block-donation-wrapper">
                <div class="<?php echo esc_attr($cls_container); ?>">
                    <div class="donate-block">
                        <div class="col-left">
                            <div class="remaining-block">
                                <span class="price"><?php echo ($model->get_event_remaning()) ?></span>
                                <span class="text"> <?php echo esc_html__('Remaining to help', 'holycross') ?></span>
                                <?php
                        ...
                        <div class="col-right">
                            <div class="slz-progress-bar-01 style-1 donate-bar">
                                <div class="progress-title">
                                    <span class="progress-label"><?php esc_html_e('Donated','holycross') ?></span>
