...
function _action_slz_admin_menu_donation_add() {
	...
	add_submenu_page( 'edit.php?post_type=slz-donation', esc_html__( 'Add New Cause', 'slz' ), esc_html__( 'Add New Cause', 'slz' ), 'edit_posts', 'post-new.php?post_type=slz-causes' );
	add_submenu_page( 'edit.php?post_type=slz-donation', esc_html__( 'Cause Categories', 'slz' ), esc_html__( 'Cause Categories', 'slz' ), 'edit_posts', 'edit-tags.php?taxonomy=slz-causes-cat' );
}
