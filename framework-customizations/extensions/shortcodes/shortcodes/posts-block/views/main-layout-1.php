<div class="slz-block-item-01 style-1">
	...
	<div class="block-content">
		<div class="block-content-wrapper">
			...
			<?php if( ( $module->attributes['main_show_meta'] == 'yes' && $module->attributes['layout'] == 'layout-1' ) || ( $module->attributes['layout'] == 'layout-2' && $module->attributes['main_show_meta_2'] == 'yes' ) ): ?>
			<ul class="block-info">
