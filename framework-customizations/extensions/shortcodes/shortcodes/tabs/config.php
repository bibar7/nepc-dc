...
$cfg ['styles'] = array (
	'style-1'  => esc_html__( 'United States', 'holycross' ),
	'style-2'  => esc_html__( 'India', 'holycross' )
);

$cfg ['page_builder'] = array (
	'title' => esc_html__( 'SLZ Tabs', 'holycross' ),
	'description' => esc_html__( 'Box of pricing info', 'holycross' ),
	...
	'default_content' => '
		[vc_tta_section title="' . sprintf( '%s %d', __( 'Tab', 'holycross' ), 1 ) . '"][/vc_tta_section]
		[vc_tta_section title="' . sprintf( '%s %d', __( 'Tab', 'holycross' ), 2 ) . '"][/vc_tta_section]
	',
);
