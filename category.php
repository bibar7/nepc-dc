...
get_header();
$holycross_container = holycross_get_container_class( 'category-article-style' );
?>
	...
	<div class="slz-main-content">
		...
		<div class="container">
			...
			<div id="page-content" class="slz-blog-detail <?php echo esc_attr( $holycross_container['sidebar_layout_class'] ); ?> margin-top-100 margin-bottom-100">

				<div class="row">

					<div class="<?php echo esc_attr( $holycross_container['content_class'] ); ?> slz-content-column">
						...
						<?php if ( have_posts() ) : ?>
							...
							<div class="slz-list-block <?php echo esc_attr( $holycross_container['block_class'] ); ?>">
								...
								<?php
									...
									if ( $holycross_template = holycross_check_article_layout('articles', 'category-article-style') ) {
