...
$holycross_container = holycross_get_container_class( 'main-blog-article-style' );
...
get_header();?>
	...
	<div class="slz-main-content">
		...
		<div class="container">
			...
			<div class="slz-blog-detail slz-block-index <?php echo esc_attr( $holycross_container['sidebar_layout_class'] ); ?> margin-top-100 margin-bottom-100">

				<div class="row">

					<div id="page-content" class="<?php echo esc_attr( $holycross_container['content_class'] ); ?> slz-posts slz-content-column">
						...
						<?php if ( have_posts() ) : ?>
							...
							<div class="slz-list-block <?php echo esc_attr( $holycross_container['block_class'] ); ?>">
								...
								<?php
									if ( $holycross_template = holycross_check_article_layout('articles', 'main-blog-article-style') ) {
